...
import { PlusCircle, Users, RefreshCw, LogOut, Paperclip, StickyNote, SendHorizontal, Search } from 'lucide-react';
...
const ChatbotInterface = () => {
  ...
  useEffect(() => {
    handleWelcomeVisibility(messages, flashCardMode, pdfRagMode);
  }, [messages, flashCardMode, pdfRagMode]);
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path d="M8.59 16.59L10 18l6-6-6-6-1.41 1.41L13.17 12z"/>
            ...
            <div className="pdf-rag-upload">
              ...
              <input type="file" accept=".pdf" multiple onChange={handleFileUpload} />
              <button onClick={handlePdfRagSubmit}>Process PDF</button>
            </div>
            )}
            {
